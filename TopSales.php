...
$sql=mysqli_query($conn,"SELECT * FROM trend WHERE category='TopSales'");
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <link rel="stylesheet" href="TopSales.css">
...
<section id="sellers">
        <div class="seller container">
          ...
          <?php
             ...
             ?>
            <a href="TopSales_details.php ?  Id= <?php echo $row["P_Id"] ; ?>">
