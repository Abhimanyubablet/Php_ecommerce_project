...
<body>
    ...
    <table class="tab">
    <h3 class="head text-center"> TRENDS ADD PRODUCT</h3>
    <hr class="border_bottom"/>
    <form class="QQQ" action="Trend_Insert_product.php" method="post" enctype="multipart/form-data"  >
  <div class="col">
  <br>
    <div class=" col-sm-12 col-md-12 col-lg-6  mx-auto">
      <input name="P_Id" type="text" class="form-control" placeholder="P_Id">
    </div>
    <br>
    <div class="col-sm-12 col-md-12 col-lg-6  mx-auto">
